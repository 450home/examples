"""End-to-end test for the ``python-playwright-chromium`` example.

Mirrors the manual steps from ``python-playwright-chromium/README.md``:

1. ``unikraft build . --output <prefix>/python-playwright-chromium:<tag>``

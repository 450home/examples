"""End-to-end test for the ``feature-change-instance-cmd`` example.

Mirrors the manual steps from ``feature-change-instance-cmd/README.md``:

1. ``unikraft build . --output <prefix>/feature-change-instance-cmd:<tag>``

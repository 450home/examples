...
fra    httpserver-node21-solid-start-lvoa2  running  <my-org>/httpserver-node21-solid-start@sha256        512MiB  1      long-star-1tms9h1z.fra.unikraft.app  2 minutes ago
```
